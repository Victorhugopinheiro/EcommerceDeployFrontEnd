                            ...
                            <div className="flex gap-2 mt-6">
                                <div className="flex gap-2">
                                    <button onClick={() => addItem({
                                        ...
                                        quantity: 1,
                                        checked: true
                                    })} className="bg-black text-white px-3 py-1 text-xl flex justify-center items-center" >+</button>
                                    <div className="flex justify-center items-center">
                                        {nowProduct?.quantity ? nowProduct?.quantity : 0}

                                    </div>
                                    <button onClick={() => removeItem(product.id)} className="text-xl border flex justify-center items-center px-3 py-1" >-</button>
                                </div>
