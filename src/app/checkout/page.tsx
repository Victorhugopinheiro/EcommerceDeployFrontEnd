                                                ...
                                                <div className="flex gap-2 justify-between items-center">
                                                    <div className="flex justify-center items-center gap-2">
                                                        <button onClick={() => addItem({
                                                            ...product,
                                                            quantity: 1,
                                                        })} className="bg-black text-white h-6 w-6 flex justify-center items-center " >+</button>
                                                        <div className="flex justify-center items-center">
                                                            {product.quantity}
                                                        </div>

                                                        <button onClick={() => removeItem(product.id)} className=" flex justify-center items-center  bg-black text-white h-6 w-6" >-</button>
                                    ...
                                    <div className="w-full h-full  px-5 flex flex-col gap-2 md:w-full lg:w-6/12 xl:w-5/12">
                                        <form action={validarCEP}>
                                            ...
                                            <div className="flex w-6/12  gap-1 justify-center items-center lg:w-10/12 xl:w-10/12">
                                                ...
                                                <button disabled={customerCep === "" ? true : false} className="flex justify-center items-center  h-6 w-1/12 bg-blue-600  text-white"><Check 
                                                size={26} /></button>
